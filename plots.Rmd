...
#specific adds
vars = c(vars,"hip_fracture","moderate_depression","moderately_severe_depression","depression_difficulties")
vars = c(vars,"CERAD","CERADDR","AFT","DSST") 
...
marrangeGrob(list(gage,gt),nrow=1,ncol=2,top=NULL)
...
aggopts =  "stats"
if(useAC) aggopts = sprintf("%s_ac",aggopts)
...
g = ggplot(Xf,aes(x=survey_year,y=100*bin_hrt_now))+
  stat_summary()+
